#
#  Be sure to run `pod spec lint SPHaChiLearning.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.platform     = :ios, "8.0"
  ...
  s.source       = { :git => "https://github.com/shuiping2018/SPHaChiLearning.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", "SPHaChiLearningDemo/SPHaChiLearning/**/*.{h,m}"
